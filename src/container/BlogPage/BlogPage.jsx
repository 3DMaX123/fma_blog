        ...
        <div className="BlogPage-text">
          ...
          <div className="BlogPage-content">
            <div className="blog_picture">
              <img
                src="https://smurfmania.com/wp-content/uploads/2022/03/scuba-gragas.jpg"
                alt="Scuba"
              />
            </div>
            <div className="blog_name">
              <p>
                Як підвищити органічну видачу сайту, або як не зійти з розуму?
              </p>
            </div>

            <div className="blog_describe">
              <p>
                Ми навіть не уявляємо, як працюємо ми, то чому ми змогли уявити,
                що нам під силу дізнатися як працює SEO?
              </p>
            </div>
...
<path d="M0 1.25H1039V0.75H0V1.25Z" fill="black" fill-opacity="0.3"/>
        ...
        <div className="BlogPage-other">
          <div className="other2">
            <div className="other-goBack" onClick={() => window.open("google.com")}>
            ...
            <div className="profile">
              ...
              <div className="profile_describe">
                У мене є багато аналітики щодо гачі відео та порад, як потрапити
                до зйомок у якості актора, підписуйся та насолоджуйся
              </div>
            ...
            <div className="recomendation">
              ...
              <div className="rec_profile">
                <img
                  className="rec_profile_logo"
                  src="https://lastfm.freetls.fastly.net/i/u/300x300/f939d9be5da0095a78bfb5cf45aecf39"
                />
                <div className="column_sort">
                  ...
                  <div className="rec_name">
                    Мій профіль сконцентрований на гачі костюмах, приєднуйся{" "}
                  </div>
                </div>
              </div>
              <SmallPlatesBlogPage
